...
- (void)startWithConfig:(CountlyConfig *)config
{
  ...
  CLY_LOG_I(@"%s initializing, appKey: [%@], serverUrl: [%@], sdkName: [%@], sdkVersion: [%@], device: [%@], osName: [%@], osVersion: [%@], defaultSDKName: [%@], defaultSDKVersion: [%@]", __FUNCTION__, config.appKey, config.host, CountlyCommon.sharedInstance.SDKName,
            CountlyCommon.sharedInstance.SDKVersion, CountlyDeviceInfo.device, CountlyDeviceInfo.osName, CountlyDeviceInfo.osVersion, kCountlySDKName, kCountlySDKVersion);
...
- (void)halt:(BOOL)clearStorage
{
  ...
  if (clearStorage)
  {
    ...
    NSArray *sdkKeys = @[
      @"kCountlyServerConfigPersistencyKey", @"kCountlyHealthCheckStatePersistencyKey", @"kCountlyQueuedRequestsPersistencyKey", @"kCountlyStartedEventsPersistencyKey", @"kCountlyStoredDeviceIDKey", @"kCountlyStoredNSUUIDKey", @"kCountlyStarRatingStatusKey", @"kCountlyRemoteConfigKey",
      @"kCountlyIsCustomDeviceIDKey", @"kCountlyNotificationPermissionKey", @"kCountlyWatchParentDeviceIDKey"
    ];
