...
- (void)mergeBehaviorSettings:(NSMutableDictionary *)baseConfig withConfig:(NSDictionary *)newConfig
{
...
{
  if (_userPropertyFilterSet.count == 0)
    return YES;
