 ...
 * @discussion Push tokens from users who have not gave permission to display notifications can be used to send silent notifications.
 */
 ...
 */
@property (nonatomic, readwrite) BOOL doNotShowAlertForNotifications;
