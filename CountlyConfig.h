...
/**
 * For sending push tokens to Countly server even for users have not granted permission to display notifications.
 * @discussion Push tokens from users not gave permission can be used to send silent notification.
 */
@property (nonatomic) BOOL shouldSendTokenAlways;

/**
 * For disabling automatical showing of alerts generated by @c CLYPushNotifications feature.
 * @discussion If set, push notifications that contain message or url visit request will not show alerts automatically. Push Open event will be recorded, but Push Action event needs to be recorded manually.
 */
